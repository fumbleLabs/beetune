...
class TestFileProcessor:
    ...
    def test_extract_text_pdf_unsupported(self) -> None:
    ...
    def test_extract_text_tex(self) -> None:
...
class TestFileSecurity:
    ...
    def test_validate_empty_filename(self) -> None:
    ...
    def test_validate_no_extension(self) -> None:
    ...
    def test_secure_filename(self) -> None:
