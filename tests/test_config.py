...
class TestConfig:
    ...
    def test_initial_config_empty(self) -> None:
    ...
    def test_set_openai_provider(self) -> None:
        """Test setting OpenAI provider configuration."""
        self.config.set_provider(AIProvider.OPENAI, api_key="sk-test123", model="gpt-4")
    ...
    def test_set_ollama_provider(self) -> None:
    ...
    def test_multiple_providers(self) -> None:
        ...
        self.config.set_provider(
            AIProvider.OLLAMA, "ollama", endpoint="http://localhost:11434/v1", model="llama3.2"
        )
        assert self.config.get_active_provider() == "ollama"
    ...
    def test_get_provider_config_specific(self) -> None:
    ...
    def test_remove_active_provider(self) -> None:
    ...
    def test_error_no_api_key(self) -> None:
    ...
    def test_config_file_corruption(self) -> None:
